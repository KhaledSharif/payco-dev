...
import Image1 from "./jpg/6-cropped.png";
...
const CommonHeadingStyle = {  "fontSize": "1.55vw", "lineHeight": "2.0vw"  }

function MainCard() {
    let MainCardHeading;

    MainCardHeading = <p style={CommonHeadingStyle}>
        Easily accept fiat and crypto currencies, both <br/> in-store and online
    </p>
